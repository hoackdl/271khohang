...
class PurchaseOrder(models.Model):
    ...
    def save(self, *args, **kwargs):
        if not self.fiscal_year:
            if self.invoice and self.invoice.fiscal_year:
                self.fiscal_year = self.invoice.fiscal_year
            else:
                self.fiscal_year = self.created_at.year
...
class BankPayment(models.Model):
    ...
    stt = models.CharField(max_length=50, blank=True, null=True, default="")
