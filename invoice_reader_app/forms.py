...
class ProductForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'nhom_hang': forms.Select(attrs={       'class': 'form-select',            }),        
        }
...
PurchaseOrderItemFormSet = inlineformset_factory(
    PurchaseOrder,  # ✅ class, không phải string
    PurchaseOrderItem,
    ...
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={
                "class": "form-control",
                "placeholder": "VD: CH271"
            }),
            "name": forms.TextInput(attrs={
                "class": "form-control",
                "placeholder": "Tên trung tâm chi phí"
            }),
