...
from .services.mst import tra_cuu_mst_selenium
...
def get_or_create_customer_by_mst(request):
    ...
    return JsonResponse({
        ...
        "dia_chi": customer.dia_chi,
        "source": "tax",
        "image_url": customer.mst_image.url if customer.mst_image else "",
    })
