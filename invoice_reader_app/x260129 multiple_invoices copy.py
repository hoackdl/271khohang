    ...
    try:
        ...
        with transaction.atomic():
            for pack in invoices_list:
                ...
                ngay_hd = parse_date_safe(inv.get("ngay_hd")) if inv.get("ngay_hd") else None
                ...
                ky_hieu=ky_hieu,        # ✅ ĐÃ CÓ
                so_hoa_don=so_hoa_don,
                mau_so=mau_so,          # 🔥 THÊM DÒNG NÀY
                ma_so_thue=ma_so_thue,
                loai_hd=loai_hd,        # ✅
                defaults={
                    "ngay_hd": ngay_hd,     # ✅ đưa vào defaults
